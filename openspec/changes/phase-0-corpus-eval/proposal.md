...
- New artifacts: `corpus/manifest.yaml` (or equivalent), `evals/golden.jsonl`, optional scrape/download script
- Network dependency: https://www.porthalifax.ca/about-us/port-authority/reports/
